"""
Calendario de Recordatorios - IAM (Asistente para el Adulto Mayor).

Genera fechas disponibles para recordatorios personales del adulto mayor
(citas médicas, cumpleaños, eventos familiares, etc.) de lunes a sábado,
excluyendo festivos colombianos.
...
if __name__ == "__main__":
    print("=== Calendario de Recordatorios IAM (Adulto Mayor) ===\n")
