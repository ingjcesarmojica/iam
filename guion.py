...
INTENCIONES = {
    ...
    "emergencia": [
        ...
        "me desmayé", "me desmaye", "me sangra", "no siento una pierna",
        "no siento un brazo", "se me durmió", "se me durmio",
        "mareo fuerte", "me mareo", "vomito sangre",
        "estoy mareado", "estoy mareada", "muy mareado", "muy mareada",
        "me siento mareado", "me siento mareada",
        "me siento muy mareado", "me siento muy mareada",
        "no veo bien", "veo borroso", "veo doble",
        # Síntomas de alarma (módulo salud)
        "dolor de pecho", "dolor en el pecho", "dolor de cabeza fuerte",
        "confusión repentina", "no puedo mover", "se me fue la fuerza",
        "no puedo hablar bien", "se me torció la cara",
    ],
    "salud": [
